...
import be.e_contract.mycarenet.xkms2.KeyBindingAuthenticationSignatureSOAPHandler;
import be.e_contract.mycarenet.xkms2.XKMS2ServiceFactory;
import be.fedict.trust.test.PKIBuilder;

public class KeyBindingAuthenticationSignatureSOAPHandlerTest {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(KeyBindingAuthenticationSignatureSOAPHandlerTest.class);
	...
	public void testHandleMessage() throws Exception {
		...
		KeyBindingAuthenticationSignatureSOAPHandler testedInstance = new KeyBindingAuthenticationSignatureSOAPHandler();
		testedInstance.setSigner(privateKey, certificate);
		...
		soapBodyElement.addChildElement(new QName(XKMS2ServiceFactory.XKMS2_NAMESPACE, "KeyBindingAuthentication"));
