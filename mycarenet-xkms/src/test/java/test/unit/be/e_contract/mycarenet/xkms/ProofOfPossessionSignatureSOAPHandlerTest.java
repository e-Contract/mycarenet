...
package test.unit.be.e_contract.mycarenet.xkms;
...
import be.e_contract.mycarenet.xkms.ProofOfPossessionSignatureSOAPHandler;
import be.e_contract.mycarenet.xkms.XKMSServiceFactory;
...
public class ProofOfPossessionSignatureSOAPHandlerTest {
	...
	public void testHandleMessage() throws Exception {
		...
		testedInstance.setPrototypeId("prototype-key-binding-id");
		...
		SOAPBodyElement soapBodyElement = soapBody
				.addBodyElement(new QName(XKMSServiceFactory.XKMS_NAMESPACE, "Register"));
		soapBodyElement.addChildElement(new QName(XKMSServiceFactory.XKMS_NAMESPACE, "ProofOfPossession"));
		SOAPElement prototypeElement = soapBodyElement
				.addChildElement(new QName(XKMSServiceFactory.XKMS_NAMESPACE, "Prototype"));
