...
import be.e_contract.mycarenet.async.SecuritySOAPHandler;
...
public class WSSecuritySOAPHandlerTest {
	...
	public void testHandleMessage() throws Exception {
		...
		PackageLicenseKey packageLicenseKey = new PackageLicenseKey("username", "password");
		SecuritySOAPHandler testedInstance = new SecuritySOAPHandler(sessionKey, packageLicenseKey);
